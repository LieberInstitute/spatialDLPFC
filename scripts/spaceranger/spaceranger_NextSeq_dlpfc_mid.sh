...
# --image=/dcl02/lieber/ajaffe/SpatialTranscriptomics/LIBD/spatialDLPFC/Images/Liebert_Institute_OTS-20-7748_rush-001_mid_1.tif \
# --slide=V19B23-074 \
# --area=A1 \
# --jobmode=local \
# --localcores=8 \
...
# --id=DLPFC_Br8492_mid \
# --transcriptome=/dcl02/lieber/ajaffe/SpatialTranscriptomics/refdata-gex-GRCh38-2020-A \
# --fastqs=/dcl02/lieber/ajaffe/SpatialTranscriptomics/LIBD/spatialDLPFC/FASTQ/8_DLPFC_Br8492_mid \
# --image=/dcl02/lieber/ajaffe/SpatialTranscriptomics/LIBD/spatialDLPFC/Images/Liebert_Institute_OTS-20-7748_rush-001_mid_4.tif \
# --slide=V19B23-074 \
# --area=D1 \
# --jobmode=local \
# --localcores=8 \
...
spaceranger count \
--id=DLPFC_Br6423_mid_11 \
--transcriptome=/dcl02/lieber/ajaffe/SpatialTranscriptomics/refdata-gex-GRCh38-2020-A \
--fastqs=/dcl02/lieber/ajaffe/SpatialTranscriptomics/LIBD/spatialDLPFC/FASTQ/11_DLPFC_Br6423_post \
--image=/dcl02/lieber/ajaffe/SpatialTranscriptomics/LIBD/spatialDLPFC/Images/Liebert_Institute_OTS-20-7748_rush-001_mid_3.tif \
--slide=V19B23-074 \
--area=C1 \
--jobmode=local \
