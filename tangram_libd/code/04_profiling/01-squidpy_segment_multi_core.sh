#$ -cwd
#$ -o ../../processed-data/04_profiling/01-squidpy_segment_multi_core.log
#$ -e ../../processed-data/04_profiling/01-squidpy_segment_multi_core.log
#$ -N squidpy_segment_multi_core
#$ -l caracol,mf=3G,h_vmem=3G
#$ -pe local 4
