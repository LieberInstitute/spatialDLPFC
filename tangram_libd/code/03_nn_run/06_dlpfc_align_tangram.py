...
ad_map.write_h5ad(os.path.join(processed_dir, 'ad_map_' + sample_name + '.h5ad'))
ad_ge.write_h5ad(os.path.join(processed_dir, 'ad_ge_' + sample_name + '.h5ad'))
ad_sp.write_h5ad(
    os.path.join(processed_dir, 'ad_sp_aligned_' + sample_name + '.h5ad')
)
