#   Use the tutorial data but my cell2location code. Since the results were bad
#   with 02-our_code.py, this script is a copy I'll iteratively modify until I
#   get good/consistent results.
...
results_folder = pyhere.here(
    ...
    "modified_tutorial_results_fixed"
)
plot_dir = pyhere.here(
    'cell2location', 'plots', '02-tutorial_data',
    'modified_tutorial_results_fixed'
)
