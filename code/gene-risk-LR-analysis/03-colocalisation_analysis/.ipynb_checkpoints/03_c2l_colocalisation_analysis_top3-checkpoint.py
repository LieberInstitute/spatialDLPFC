...
lut = dict(zip(dfLR.columns, ["#3BB273","#FF56AF","#663894","#E07000","#D2B037","#D0D1E6","#A6BDDB","#74A9CF","#3690C0","#0570B0","#045A8D","#023858","#E94F37"]))
row_colors = dfLR.columns.map(lut)

sns.clustermap(np.tril(LRadjmat/ctrladjmat), cmap = 'inferno_r', row_colors=row_colors, col_colors=row_colors, col_cluster=False, row_cluster=False)
