...
adata1 = sc.read("../../../../DLPFC_Visium_LIBD/processed-data/spot_deconvo/05-shared_utilities/IF/spe.h5ad")
adata1.obs['key'] = adata1.obs.index+'_'+adata1.obs['sample_id'].astype(str)

adata2 = sc.read("../../../../DLPFC_Visium_LIBD/processed-data/spot_deconvo/05-shared_utilities/nonIF/spe.h5ad")
adata2.obs['key'] = adata2.obs.index+'_'+adata2.obs['sample_id'].astype(str)

adata = adata1.concatenate(adata2)

df1 = pd.read_csv("../../../../DLPFC_Visium_LIBD/processed-data/01-tangram/IF/layer/raw_results/clusters.csv")
df2 = pd.read_csv("../../../../DLPFC_Visium_LIBD/processed-data/01-tangram/nonIF/layer/raw_results/clusters.csv")
