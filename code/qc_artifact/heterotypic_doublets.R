...
Br6522_ant$Wrinkles <- factor(Br6522_ant$Wrinkles, levels = c("None", "Fold_1", "Shear_1", "Shear_2", "Shear_3", "Wrinkle_1", "Wrinkle_2", 
                                                              "Wrinkle_3", "Wrinkle_4", "Wrinkle_5", "Wrinkle_6", "Wrinkle_7", "Wrinkle_8", 
                                                              "Wrinkle_9"))
Br6522_mid$Wrinkles <- factor(Br6522_mid$Wrinkles, levels = c("None", "Fold_1", "Shear_1", "Shear_2", "Wrinkle_1", "Wrinkle_2", 
                                                              "Wrinkle_3", "Wrinkle_4", "Wrinkle_5", "Wrinkle_6", "Wrinkle_7", "Wrinkle_8", 
                                                              "Wrinkle_9", "Wrinkle_10", "Wrinkle_11", "Wrinkle_12", "Wrinkle_13"))
Br8667_post$Wrinkles <- factor(Br8667_post$Wrinkles, levels = c("None", "Shear_1", "Wrinkle_1", "Wrinkle_2", 
                                                                "Wrinkle_3", "Wrinkle_4", "Wrinkle_5", "Wrinkle_6", "Wrinkle_7", "Wrinkle_8", 
...
Br6522_ant_all <-  ScaleData(Br6522_ant_all, vars.to.regress = c("nFeature_RNA", "percent_mito"),
                            verbose = F)
...
Br6522_mid_all <-  ScaleData(Br6522_mid_all, vars.to.regress = c("nFeature_RNA", "percent_mito"),
                             verbose = F)
...
Br8667_post_all <-  ScaleData(Br8667_post_all, vars.to.regress = c("nFeature_RNA", "percent_mito"),
                             verbose = F)
...
df2 <- df[ ,c(6, 38, 39, 40)] %>% group_by(Wrinkles) %>% 
       summarise(across(everything(), mean),
            .groups = 'drop')  %>%
         as.data.frame()
df3 <- df[ ,c(6, 38, 39, 40)] %>% group_by(Wrinkles) %>% 
...
df2$Wrinkles <- factor(df2$Wrinkles, levels = c("None", "Fold 1", "Shear 1", "Shear 2", 
...
ggplot(df2, aes(x = Wrinkles, y = value, fill = variable)) + geom_bar(position="dodge", stat="identity") + 
  geom_errorbar(aes(ymin=value-0.5*sd, ymax=value+0.5*sd), width=.2,position=position_dodge(.9)) +
  theme_classic() + xlab("") + ylab("Proportion of NN") + ggtitle("Br6522 Anterior") +
...
ggplot(df2, aes(x = Wrinkles, y = value, fill = variable)) + geom_bar(position="dodge", stat="identity") + 
  geom_errorbar(aes(ymin=value-0.5*sd, ymax=value+0.5*sd), width=.2,position=position_dodge(.9)) +
  theme_classic() + xlab("") + ylab("Proportion of NN") + ggtitle("Br6522 Middle") +
  theme(legend.title=element_blank(), plot.title = element_text(face = "bold"))
dev.off()
...
df <- df[!df$Type == "Simulated doublet", ]
df$Layer_Wrinkle <- paste(df$Layers, as.numeric(!df$Wrinkles == "None"), sep = "-")
df2 <- df[ ,c(6, 25, 26, 27)] %>% group_by(Wrinkles) %>% 
  summarise(across(everything(), mean),
            .groups = 'drop')  %>%
  as.data.frame()
df3 <- df[ ,c(6, 25, 26, 27)] %>% group_by(Wrinkles) %>% 
  summarise(across(everything(),sd),
            .groups = 'drop')  %>%
  as.data.frame()
df2 <- reshape2::melt(df2)
...
df2$sd <- df3$value
df2$Wrinkles <- gsub("_", " ", df2$Wrinkles)
df2$Wrinkles <- factor(df2$Wrinkles, levels = c("None", "Shear 1",
                                                "Wrinkle 1", "Wrinkle 2", 
                                                "Wrinkle 3", "Wrinkle 4", "Wrinkle 5", 
                                                "Wrinkle 6", "Wrinkle 7", "Wrinkle 8", 
...
ggplot(df2, aes(x = Wrinkles, y = value, fill = variable)) + geom_bar(position="dodge", stat="identity") + 
  geom_errorbar(aes(ymin=value-0.5*sd, ymax=value+0.5*sd), width=.2,position=position_dodge(.9)) +
  theme_classic() + xlab("") + ylab("Proportion of NN") + ggtitle("Br8667 Posterior") +
  theme(legend.title=element_blank(), plot.title = element_text(face = "bold"))
dev.off()
...
DimPlot(Br6522_ant_all, split.by = "Type", cells.highlight = list("Layer 1" = L1_cells, "Layer 5" = L5_cells, "Layer 1/Layer 5"= L_1_5_cells), 
        cols.highlight = c("blue", "purple", "red"), cols= "grey") + ggtitle("Br6522 Anterior") + xlab("UMAP 1") + ylab("UMAP 2")
dev.off()
...
DimPlot(Br6522_mid_all, split.by = "Type", cells.highlight = list("Layer 1" = L1_cells, "Layer 5" = L5_cells, "Layer 1/Layer 5"= L_1_5_cells), 
        cols.highlight = c("blue", "purple", "red"), cols= "grey") + ggtitle("Br6522 Middle") + xlab("UMAP 1") + ylab("UMAP 2")
dev.off()
...
DimPlot(Br8667_post_all, split.by = "Type", cells.highlight = list("Layer 2" = L2_cells, "Layer 6" = L6_cells, "Layer 2/Layer 6"= L_2_6_cells), 
        cols.highlight = c("blue", "purple", "red"), cols= "grey") + ggtitle("Br8667 Posterior") + xlab("UMAP 1") + ylab("UMAP 2")
dev.off()
