...
if (sample == "Br6522_ant") {
    map_cellType$Wrinkle <- factor(map_cellType$Wrinkle, levels = c(
        "None", "Fold_1", "Shear_1", "Shear_2",
...
if (sample == "Br6522_mid") {
    map_cellType$Wrinkle <- factor(map_cellType$Wrinkle, levels = c(
        "None", "Fold_1", "Shear_1", "Shear_2", "Wrinkle_1",
...
ggplot(map_cellType, aes(x = Layer, y = sumCells, fill = Wrinkle)) +
    geom_boxplot() +
    theme_classic()
...
if (!sample == "Br8667_post") {
    ...
    ggplot(L1, aes(x = U1, y = U2, colour = Wrinkle)) +
        geom_point() +
        theme_classic()
    ggplot(L1, aes(x = U1, y = U2, colour = sumCells)) +
        geom_point() +
        theme_classic()
    ...
    corrplot(cor(L1[, 1:7]),
        method = "color", diag = TRUE, type = "upper", addCoef.col = "black",
...
ggplot(L2, aes(x = U1, y = U2, colour = Wrinkle)) +
    geom_point() +
    theme_classic()
ggplot(L2, aes(x = U1, y = U2, colour = sumCells)) +
    geom_point() +
    theme_classic()
...
ggplot(L3, aes(x = U1, y = U2, colour = Wrinkle)) +
    geom_point() +
    theme_classic()
ggplot(L3, aes(x = U1, y = U2, colour = sumCells)) +
    geom_point() +
    theme_classic()
...
ggplot(L4, aes(x = U1, y = U2, colour = Wrinkle)) +
    geom_point() +
    theme_classic()
ggplot(L4, aes(x = U1, y = U2, colour = sumCells)) +
    geom_point() +
    theme_classic()
...
ggplot(L5, aes(x = U1, y = U2, colour = Wrinkle)) +
    geom_point() +
    theme_classic()
ggplot(L5, aes(x = U1, y = U2, colour = sumCells)) +
    geom_point() +
    theme_classic()
...
ggplot(L6, aes(x = U1, y = U2, colour = Wrinkle)) +
    geom_point() +
    theme_classic()
ggplot(L6, aes(x = U1, y = U2, colour = sumCells)) +
    geom_point() +
    theme_classic()
...
if (!sample == "Br8667_post") {
    ...
    ggplot(WM, aes(x = U1, y = U2, colour = Wrinkle)) +
        geom_point() +
        theme_classic()
    ggplot(WM, aes(x = U1, y = U2, colour = sumCells)) +
        geom_point() +
        theme_classic()
...
plot_heatmap <- function(pvalue_df, layer) {
    ...
    pheatmap(p_value_mat,
        cluster_rows = FALSE, cluster_cols = FALSE, display_numbers = sig_mat,
        color = colorRampPalette(rev(brewer.pal(n = 7, name = "Reds")))(100), breaks = seq(0, 1, 0.01),
