...
Sys.time()
lobstr::obj_size(spe) ## takes about 1 min
Sys.time()
# 6.92 GB
...
## Save for later use, takes about 6 min
Sys.time()
saveRDS(
    spe,
    file = here(
...
## Save for use in the spatialLIBD shiny apps, takes about 2 min
Sys.time()
saveRDS(
    spe,
    file = here(
...
# ─ Session info ───────────────────────────────────────────────────────────────────────────────────────────────
# setting  value
# version  R version 4.2.2 Patched (2023-02-05 r83786)
...
# jaffelab               * 0.99.32   2022-09-20 [1] Github (LieberInstitute/jaffelab@7b7afe3)
...
# lubridate                1.9.1     2023-01-24 [2] CRAN (R 4.2.2)
