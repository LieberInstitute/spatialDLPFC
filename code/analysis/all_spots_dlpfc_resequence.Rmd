...
```{r}
sample_names <- c("DLPFC_Br6423_mid_extra_reads")
...
for (i in seq_along(sample_names)) {
  ...
  if (Sys.info()["sysname"] == "Linux") {
    ...
    dir_outputs <- "/dcs04/lieber/lcolladotor/spatialDLPFC_LIBD4035/spatialDLPFC/processed-data/NextSeq"
  } else if (Sys.info()["sysname"] == "Darwin") {
    # copy of files on Mac laptop
    dir_outputs <- "/dcs04/lieber/lcolladotor/spatialDLPFC_LIBD4035/spatialDLPFC/plots"
  }
...
dir_plot <- here("plots", "features_per_spot_all_spots_Br6423_mid_extra_reads")
