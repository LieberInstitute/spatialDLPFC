...
load(file = here::here("processed-data", "rdata", "spe", "08_layer_differential_expression", "parsed_modeling_results_k16.Rdata"))
...
long <- modeling_results_9 %>% select(ensembl, starts_with("t_stat")) %>% pivot_longer(!ensembl)
head(long)
...
pdf(file = "/dcs04/lieber/lcolladotor/spatialDLPFC_LIBD4035/spatialDLPFC/plots/08_layer_differential_expression/num_enriched_genes_per_cluster_bar.pdf")
...
pdf(file = "/dcs04/lieber/lcolladotor/spatialDLPFC_LIBD4035/spatialDLPFC/plots/08_layer_differential_expression/num_depleted_genes_per_cluster_bar.pdf")
ggplot(df, aes(x=cluster,y=num_genes)) +
