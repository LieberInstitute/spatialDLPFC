...
#$ -N layer_parse_modeling_results
#$ -o logs/layer_parse_modeling_results.$TASK_ID.txt
#$ -e logs/layer_parse_modeling_results.$TASK_ID.txt
#$ -m e
#$ -t 2-28
#$ -tc 4
...
Rscript 08a_layer_parse_modeling_results.R
