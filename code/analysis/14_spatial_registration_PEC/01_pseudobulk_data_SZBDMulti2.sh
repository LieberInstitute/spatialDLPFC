#!/bin/bash
#$ -cwd
#$ -l caracol,mem_free=250G,h_vmem=250G,h_fsize=100G
#$ -N pseudobulk_data_SZBDMulti
#$ -o logs/01_pseudobulk_data_SZBDMulti2.txt
#$ -e logs/01_pseudobulk_data_SZBDMulti2.txt
#$ -m e
...
Rscript 01_pseudobulk_data_SZBDMulti2.R
