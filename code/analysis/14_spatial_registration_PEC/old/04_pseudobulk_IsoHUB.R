...
### load IsoHUB dataset
########################
sce <- readH5AD(file = "/dcs04/lieber/lcolladotor/spatialDLPFC_LIBD4035/spatialDLPFC/raw-data/psychENCODE/version2/IsoHuB/IsoHuB-snRNAseq_annotated.h5ad")
...
saveRDS(sce, file = "/dcs04/lieber/lcolladotor/spatialDLPFC_LIBD4035/spatialDLPFC/processed-data/rdata/spe/14_spatial_registration_PEC/IsoHUB_sce.rds")
...
saveRDS(spe_pseudo, file = "/dcs04/lieber/lcolladotor/spatialDLPFC_LIBD4035/spatialDLPFC/processed-data/rdata/spe/14_spatial_registration_PEC/IsoHUB_spe_pseudo.rds")
...
save(pvals0_contrasts_cluster,
    ...
    file = "/dcs04/lieber/lcolladotor/spatialDLPFC_LIBD4035/spatialDLPFC/processed-data/rdata/spe/14_spatial_registration_PEC/IsoHUB_modeling_results.rda"
)
...
pdf("/dcs04/lieber/lcolladotor/spatialDLPFC_LIBD4035/spatialDLPFC/plots/14_spatial_registration_PEC/IsoHUB/spatial_registration_plot_IsoHUB_v_manual.pdf")
...
pdf("/dcs04/lieber/lcolladotor/spatialDLPFC_LIBD4035/spatialDLPFC/plots/14_spatial_registration_PEC/IsoHUB/spatial_registration_plot_IsoHUB_v_k9.pdf")
layer_stat_cor_plot(cor)
dev.off()
...
pdf("/dcs04/lieber/lcolladotor/spatialDLPFC_LIBD4035/spatialDLPFC/plots/14_spatial_registration_PEC/IsoHUB/spatial_registration_plot_IsoHUB_v_k16.pdf")
layer_stat_cor_plot(cor)
dev.off()
