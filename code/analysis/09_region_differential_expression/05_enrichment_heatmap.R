...
# Load SPE
spe_pseudo <- readRDS(here::here("processed-data", "rdata", "spe", "pseudo_bulked_spe", "spe_pseudobulk_bayesSpace_normalized_filtered_region_k9.RDS"))

# Load modeling results
load(file = here::here("processed-data", "rdata", "spe", "09_region_differential_expression", "parsed_modeling_results_k9.Rdata"))
...
ann_colors <- list(BayesSpace = brewer.pal(3, "Set1"))
