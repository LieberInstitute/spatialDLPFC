...
spe <- cluster_import(
  spe,
  cluster_dir = here::here("processed-data", "rdata", "spe", "clustering_results","bayesSpace_k"), #is this right? shouldn't k be a variable?
  prefix = ""
)
...
write.table(results,file = here::here("processed-data","rdata","spe","06_fasthplus","fasthplus_results.csv"), append = TRUE)
