...
spe$merged_cluster[spe$bayesSpace_harmony_16 %in% c(12, 13)] <- "A"
...
for (s in seq_along(sample_ids)) {
    ...
    saveRDS(res_list, paste0("/dcs04/lieber/lcolladotor/spatialDLPFC_LIBD4035/spatialDLPFC/processed-data/rdata/spe/13_nnSVG/pairwise/", sample_ids[s], "_res_list_merged_pairs_12_13.rds"))
}

saveRDS(res_list, file = paste0("/dcs04/lieber/lcolladotor/spatialDLPFC_LIBD4035/spatialDLPFC/processed-data/rdata/spe/13_nnSVG/pairwise/res_list_merged_pairs_12_13.rds"))
save(res_list, file = paste0("/dcs04/lieber/lcolladotor/spatialDLPFC_LIBD4035/spatialDLPFC/processed-data/rdata/spe/13_nnSVG/pairwise/res_list_merged_pairs_12_13.Rdata"))
