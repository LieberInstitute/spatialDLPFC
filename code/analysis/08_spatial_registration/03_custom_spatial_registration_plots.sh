...
#$ -N spatial_registration_plots
#$ -o logs/spatial_registration_plots.$TASK_ID.txt
#$ -e logs/spatial_registration_plots.$TASK_ID.txt
#$ -m e
#$ -t 2-28
#$ -tc 4
...
custom_spatial_registration_plots.R
