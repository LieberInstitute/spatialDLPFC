...
#$ -o ../../../processed-data/spot_deconvo/03-cell2location/02-registration_nonIF.log
#$ -e ../../../processed-data/spot_deconvo/03-cell2location/02-registration_nonIF.log
...
python 02-registration_nonIF.py
