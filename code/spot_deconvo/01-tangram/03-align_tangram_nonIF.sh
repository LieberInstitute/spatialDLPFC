...
#$ -o ../../../processed-data/spot_deconvo/01-tangram/logs/03-align_tangram_nonIF_broad_$TASK_ID.log
#$ -e ../../../processed-data/spot_deconvo/01-tangram/logs/03-align_tangram_nonIF_broad_$TASK_ID.log
