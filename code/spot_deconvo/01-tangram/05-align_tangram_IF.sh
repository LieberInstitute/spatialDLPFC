...
#$ -cwd
#$ -N "align_tangram_IF"
#$ -o ../../../processed-data/spot_deconvo/01-tangram/logs/05-align_tangram_IF_layer_$TASK_ID.log
#$ -e ../../../processed-data/spot_deconvo/01-tangram/logs/05-align_tangram_IF_layer_$TASK_ID.log
