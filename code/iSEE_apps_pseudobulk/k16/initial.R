...
initial[["ReducedDimensionPlot1"]] <- new(
    ...
    XAxis = 1L,
    YAxis = 2L,
    FacetRowByColData = "BayesSpace",
    FacetColumnByColData = "BayesSpace",
    ColorByColumnData = "BayesSpace",
    ...
    ColorBySampleName = "Br2720_ant_Sp16D01",
    ColorBySampleSource = "---",
    ...
    CustomLabels = FALSE,
    CustomLabelsText = "Br2720_ant_Sp16D01",
    FontSize = 1,
    LegendPointSize = 1,
