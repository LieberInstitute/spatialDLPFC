...
initial[["ReducedDimensionPlot1"]] <- new("ReducedDimensionPlot", Type = "runPCA", XAxis = 1L, YAxis = 2L,
...
initial[["ComplexHeatmapPlot1"]] <- new("ComplexHeatmapPlot", Assay = "logcounts", CustomRows = TRUE,
    ...
    DataBoxOpen = FALSE, VisualChoices = "Annotations", ColumnData = c("BayesSpace",
...
initial[["RowDataTable1"]] <- new("RowDataTable", Selected = "LINC01128", Search = "", SearchColumns = c("",
...
initial[["FeatureAssayPlot1"]] <- new("FeatureAssayPlot", Assay = "logcounts", XAxis = "Column data",
    ...
    YAxisFeatureName = "LINC01128", YAxisFeatureSource = "RowDataTable1",
