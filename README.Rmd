...
* Visium
  ...
  - [spatialDLPFC_Visium_Sp09_position_noWM](https://libd.shinyapps.io/spatialDLPFC_Visium_Sp09_position_noWM): similar to _spatialDLPFC_Visium_Sp09_position_ but after dropping the `Sp02D01` spots which correspond to white matter (hence the `noWM` acronym).
