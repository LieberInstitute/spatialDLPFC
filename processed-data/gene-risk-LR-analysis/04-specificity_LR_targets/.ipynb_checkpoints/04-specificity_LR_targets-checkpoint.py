...
###--------------------------------------------LOAD DATA
adata = sc.read_h5ad("/camp/lab/gandhis/home/users/grantpm/LIBD_LR/grantpm/DLPFC_snRNAseq_LIBD/processed-data/sce/sce/sce_DLPFC_annotated/sce.h5ad")
...
###--------------------------------------------VISUALISE GENES
df = pd.read_csv('../../processed-data/02-SCZ_LRs/SCZ_top_interactions.csv')
...
plt.savefig('../../plots/04-specificity_LR_targets/heatmap_tau_allnuclei.pdf', dpi = 300)
plt.show()

tso.tissue_specificity.to_frame().to_csv('../../processed-data/04-specificity_LR_targets/tau_targets_allnuclei.csv')
...
plt.savefig('../../plots/04-specificity_LR_targets/clustermap_spm_allnuclei.pdf', dpi = 300)
plt.show()

spm.tissue_specificity.to_csv('../../processed-data/04-specificity_LR_targets/spm_targets_allnuclei.csv')